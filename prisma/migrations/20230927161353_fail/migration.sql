/*
  ...
  - A unique constraint covering the columns `[astrologer_id,user_id]` on the table `Conversation` will be added. If there are existing duplicate values, this will fail.
...
-- DropIndex
DROP INDEX `Conversation_astrologer_id_fkey` ON `conversation`;
...
-- CreateIndex
CREATE UNIQUE INDEX `Conversation_astrologer_id_user_id_key` ON `Conversation`(`astrologer_id`, `user_id`);
