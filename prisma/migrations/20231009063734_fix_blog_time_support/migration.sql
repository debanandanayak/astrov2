...
-- AlterTable
ALTER TABLE `blog_post` MODIFY `content` TEXT NOT NULL;

-- AlterTable
ALTER TABLE `support` ADD COLUMN `createdAt` DATETIME(3) NULL DEFAULT CURRENT_TIMESTAMP(3),
    ADD COLUMN `status` ENUM('open', 'inprogress', 'close') NOT NULL DEFAULT 'open',
...
-- AlterTable
ALTER TABLE `user` MODIFY `time_of_birth` TIME NULL;
